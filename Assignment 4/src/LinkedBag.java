...
// or null otherwise.
    ...
    public T remove() {
        ...
        int x=rn.nextInt(numberOfEntries);//Generating a random number
        ...
        if(x!=0)
        {
        	...
        	for(int i=0;i<x;i++)
        	{
        		...
        		prev=curr; // Traversing list "x" random nodes ahead
        		curr=curr.next;
        	}
        	//Deleting the random node
        	prev.next=curr.next;
        	curr.next=firstNode;
        	firstNode=curr;
        }
    ...
    public boolean equals(LinkedBag<T> aBag) {
        ...
        //Checking if the number of entries are not equal in the two bags
        ...
        {
        	//Checking whether the frequency of data in any node is same in the two bags
    ...
    public boolean duplicateAll() {
        ...
        //Getting number of entries in the bag
        int x=this.numberOfEntries;
        Node ptr=this.firstNode;
        for(int i=0;i<x;i++)
        {
        	//Adding the data of all the nodes in the beginning to duplicate the list 
        	this.add(ptr.data);
        	ptr=ptr.next;
        }
    ...
    public void removeDuplicates() {
        ...
        LinkedBag<T> List_1=new LinkedBag<T>();
        while(x!=null)
        {
        	//Adding the elements to new list only once
        	if(List_1.getFrequencyOf(x.data)<1)
        	{
        		List_1.add(x.data);
        	}
        	x=x.next;
        }
        this.firstNode=List_1.firstNode;
        this.numberOfEntries=List_1.numberOfEntries;
        return;
